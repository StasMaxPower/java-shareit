...
public interface BookingService {
    ...
    Collection<BookingDto> getAllBookingByUser(int userId, State state, int from, int size);

    Collection<BookingDto> getAllBookingByOwner(int ownerId, State state, int from, int size);
}
